...
test = pd.read_csv('drive/MyDrive/DataSets/Layer11/test.csv');
...
# SVM linear model gives the best results
...
# Best model is the KNN with n_neighbours = 1
...
# Best model is the SVC linear model
...
# Best model is the KNN with n_neighbours = 4

# In[ ]:


output['label_4'] = best_knn_4.predict(X_test)
output.to_csv('output.csv')
